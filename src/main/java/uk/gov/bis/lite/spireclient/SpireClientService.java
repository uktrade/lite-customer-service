...
public class SpireClientService implements SpireClient {
  ...
  private SpireResponse doCreateSiteForSar(SpireRequest spireRequest) {
    ...
    return unmarshaller.getSpireResponse(response, SpireNames.CSFS_RESPONSE_ELEMENT, SpireNames.SAR_XPATH_EXP);
  }
  ...
  private SpireResponse doCreateLiteSar(SpireRequest spireRequest) {
    ...
    return unmarshaller.getSpireResponse(response, SpireNames.CLS_RESPONSE_ELEMENT, SpireNames.SAR_XPATH_EXP);
  }
  ...
  private SpireResponse doEditUserRoles(SpireRequest spireRequest) {
    ...
    return unmarshaller.getSpireResponse(response, SpireNames.EUR_RESPONSE_ELEMENT, SpireNames.SAR_XPATH_EXP);
  }
  ...
  private SpireResponse doCreateOgelApp(SpireRequest spireRequest) {
    ...
    return unmarshaller.getSpireResponse(response, SpireNames.COA_RESPONSE_ELEMENT, SpireNames.SAR_XPATH_EXP);
  }
